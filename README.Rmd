...
```{bash example_function, engine.opts="-l",echo=FALSE,comment=NA,class="html"}
...
```{bash example_help_show, engine.opts="-l",echo=FALSE,comment=NA,class="html"}
cat "examples/example_help.sh"
```

```{bash example_help,echo=FALSE,comment=NA,class="html"}
source "examples/example_function.sh"
export TERM="linux"
...
```{bash example_int_only,echo=FALSE,comment=NA,class="html"}
source "examples/example_function.sh"
...
```{bash example_str_only,echo=FALSE,comment=NA,class="html"}
source "examples/example_function.sh"
...
```{bash example_int_and_str,echo=FALSE,comment=NA,class="html"}
source "examples/example_function.sh"
...
```{bash example_invalid_argument,echo=FALSE,comment=NA,error=TRUE,class="html",class.output="html"}
