...
```{r example_help_r,echo=FALSE,include=file.exists("examples/example_help.png")}
...
```{bash example_invalid_argument,echo=FALSE,comment=NA,error=TRUE,class.output="html",include=!file.exists("examples/example_invalid_argument.png")}
source "examples/example_function.sh"
...
```{r example_invalid_argument_r,echo=FALSE,include=file.exists("examples/example_invalid_argument.png")}
